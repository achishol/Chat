...
export default function App() {
  ...
  //places where character will pop up
  "id": 25,
  "is_default": true,
  "location_area_encounters": "https://pokeapi.co/api/v2/pokemon/25/encounters",
  "moves": [
    {
      //moves learned at a certain level or method
      "move": {
        "name": "mega-punch",
  ...
  //pixelated forms of that character
  "sprites": {
